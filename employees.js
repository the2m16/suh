...
// ⚠️ ЗӨВХӨН ТООЦООЛОЛ ХАРУУЛНА -- journal entry автоматаар vvсгэдэггүй.
// ============================================================
...
// ------------------------------------------------------------
// САР БүРИЙН ЦАЛИНГИЙН ЯВЦ (Phase 3) -- journal entry бодитоор vvсгэнэ
// ------------------------------------------------------------
...
async function runMonthlyPayroll() {
  if (!canWrite('employees')) { toast('Танд энэ үйлдлийг хийх эрх байхгvй байна', 'error'); return; }
