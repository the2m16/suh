...
// ------------------------------------------------------------
// ХӨРӨНГИЙН АНГИЛАЛ/ТӨРӨЛ/БАЙРШИЛ — "Vндсэн хөрөнгө тохиргоо" хуудсанд
// удирдагдана. Өмнө нь JS-д хатуу кодлогдож байсныг Supabase руу
// шилжvvлэв (шинэ ангилал/төрөл/байршил нэмэх vед код дахин бичих
// шаардлагагvй болно).
// ------------------------------------------------------------
...
function renderAssetTypeSettingsList() {
  ...
  if(!list.length) { el.innerHTML = '<div class="empty-state">Энэ ангилалд төрөл бvртгэгдээгvй байна</div>'; return; }
...
function renderAssetLocationSettingsList() {
  ...
  if(!el) return;
  if(!ASSET_LOCATIONS.length) { el.innerHTML = '<div class="empty-state">Байршил бvртгэгдээгvй байна</div>'; return; }
