  ...
  for(const q of (questions||[])) {
    ...
    html += `<div style="overflow:hidden;margin-bottom:16px">
      <table class="data-table" style="width:100%;border-collapse:collapse">
        <thead>
          <tr>
            <th style="text-align:left">${q.question_text}</th>
    ...
    (options||[]).forEach(o => {
      ...
      html += `<tr style="${rowBg}">
        ...
        <td class="dt-text dt-mono" style="text-align:right">${cnt}</td>
        <td class="dt-muted dt-mono" style="text-align:right">${pct}%</td>
        <td>
