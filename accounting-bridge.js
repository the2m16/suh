...
// шилжvvлэв. Одоо тухайн сарыг илгээхээс өмнө хvлээн авагчдын
// жагсаалтыг харж, зарим хvнийг ЭНЭ САРААС түр хасах (invoiceExcludedIds,
// session-only — refresh хийвэл дахин бvрэн жагсаалт руу буцна) боломжтой.
// ------------------------------------------------------------
...
async function sendMonthlyInvoice() {
  ...
  if (!rows.length) { toast('Нэхэмжлэх илгээх хvлээн авагч алга', 'error'); return; }
  if (!confirm(`${yearMonth} сарын хураамж/түрээсийг ${rows.length} хvлээн авагчид нэхэмжлэх vv?\n(Энэ үйлдлийг буцаах боломжгүй тул анхаарна уу.)`)) return;
...
// Одоогийн (илгээгээгvй) сарын урьдчилсан жагсаалт — хасагдсан
// (invoiceExcludedIds) хvлээн авагчийг оруулахгvй.
