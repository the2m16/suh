    ...
    <div class="card mb-16">
      <div class="flex-between mb-16">
        ...
        <div style="display:flex;gap:8px;align-items:center">
          ...
          <button class="btn btn-ghost btn-sm" onclick='openEditTaxType(${JSON.stringify(t).replace(/'/g, "&apos;")})'>Засах</button>
          <button class="btn btn-ghost btn-sm" style="color:var(--danger)" onclick="deleteTaxType('${esc(t.code)}')">Устгах</button>
        </div>
      </div>
