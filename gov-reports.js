  ...
  el.innerHTML = `
    <div class="card mb-16" style="padding:20px">
      ...
      <div class="grid-2" style="margin-top:24px;font-size:12px">
        <div>Дарга/захирал: ${esc(_findEmployeeNameByPosition('Гүйцэтгэх захирал')) || '.......................'}</div>
        <div>Нягтлан бодогч: ${esc(_findEmployeeNameByPosition('Нягтлан бодогч')) || '.......................'}</div>
      </div>
        ...
        <table class="data-table" style="font-size:11px" id="nd8-data-table">
          ...
          <tbody>
            ${rows.map((r, i) => `<tr>
              ...
              <td class="dt-text">${esc(r.e.parentName || '')}</td>
