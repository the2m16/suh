...
function populateBuildingSelects() {
  ...
  onResFilterBuildingChange(true); // Орцны шvvлтvvрийг ч мөн шинэчилнэ
}
// Хайлтын мужийн "Байр" сонгогдоход "Орц" dropdown-ыг тухайн байрны
// орцны тоогоор дахин угсарна ("Бvх байр" vед бvх байрны дээд орцны
// тоогоор). keepDefault=true vед зөвхөн анхны ачаалалтын vед дуудагдана.
...
function renderResidents(filter='', buildingFilter='', entranceFilter='') {
  ...
  // Бvртгэсэн огноо, дарааллаас vл хамааран ЗААВАЛ "Хаягжилт тохиргоо"-гоор
  // vvсгэсэн Тоот-ын (r.apt, тоон утга) өсөх дарааллаар харуулна.
