...
function openClienteleDetail(id) {
  ...
  document.getElementById('clientele-detail-body').innerHTML = `
    ...
    <table style="width:100%;border-collapse:collapse;font-size:13px">
      ...
      <tr><td style="padding:5px 0;color:var(--text-muted)">Эхлэх огноо</td><td style="padding:5px 0;text-align:right">${c.contractStart||'—'}</td></tr>
      <tr><td style="padding:5px 0;color:var(--text-muted)">Дуусах огноо</td><td style="padding:5px 0;text-align:right">${c.contractEnd||'—'}</td></tr>
